...
class ViewUpdater {
    ...
    update(remote_state) {
        ...
        const frequency_min = remote_state.frequency_min.toFixed(2);
        const frequency_max = remote_state.frequency_max.toFixed(2);
        const frequency = remote_state.frequency.toFixed(2);
